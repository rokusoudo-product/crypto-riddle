...
// 2026-09-14(#132/#133): 全8画面を単一のダーク文脈に統一したため、旧「ライト文脈（タイトル/
// マップ選択/カード図鑑）＝LightLayout」「ダーク文脈（導入/探索/解決/結果）＝DarkLayout」の
// レイアウト使い分けを廃止し、全ルートに DarkLayout 1つを適用する（dark-layout.tsx参照）。
