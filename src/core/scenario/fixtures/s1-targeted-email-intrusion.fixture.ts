...
export const s1TargetedEmailIntrusionFixture: Scenario = {
  ...
  intro: {
    ...
    victim_company: {
      ...
      industry: '産業資材卸売業',
      description:
        '取引先への請求書・発注書のやり取りが多い中堅の産業資材商社。経理部では日常的にメール添付のPDFや表計算ソフトのファイルを開く業務フローが定着しており、添付ファイルの多さがかえって警戒心を鈍らせていた。',
    },
    character_intros: [
      {
        character: '小鳥遊',
      ...
      {
        character: '橘',
        line: '一週間放置されていたのが気がかりね。取引先の請求データを扱う部署なら、影響範囲によっては個人情報保護法の報告義務が絡むわ。ここからは事実確認と、被害範囲の特定が先決よ。',
        expression: 'serious',
      },
      {
        character: '橘',
        line: '現場を見て、証拠を組み立ててください。私と霧島さんは、詰まったところをフォローするわ。',
  ...
  scenes: [
    {
      ...
      hotspots: [
        {
          object_type: 'pc',
          position: { landscape: [0.47, 0.62], portrait: [0.52, 0.635] },
          label: '経理部 中野の端末',
          actions: [
            {
              kind: 'collect',
              ...
              dialogue: [
                ...
                {
                  character: '霧島',
                  line: '表計算ソフトのマクロ実行に続いて、見慣れないスクリプトが起動した記録がある。正規の業務でこの並びは出ない。侵入の起点はここだ。',
                  expression: 'serious',
                },
              ],
            },
            {
              ...
              label: '感染端末の電源を落とす',
              feedback:
                '橘「待って。ここで電源を落とすと、動作中のプロセスや通信先が乗った揮発性メモリの証拠が消えるわ。まずネットワークから論理的に隔離し、メモリ→ディスクの順で保全を。」',
            },
        ...
        {
          object_type: 'person',
          position: { landscape: [0.61, 0.45], portrait: [0.545, 0.565] },
          label: '中野',
          actions: [
            {
              kind: 'collect',
              ...
              dialogue: [
                ...
                {
                  character: '橘',
                  line: '……ご本人も認めているわ。件名の巧妙さと、月末の油断が重なった。よくある入口ね。',
                  expression: 'neutral',
                },
              ],
            },
        ...
        {
          object_type: 'person',
          position: { landscape: [0.355, 0.26], portrait: [0.245, 0.45] },
          label: '経理部長',
          actions: [
            {
              kind: 'collect',
              ...
              dialogue: [
                ...
                {
                  character: '橘',
                  line: '規程はあっても、現場に届いていなければ機能しないわ。ここは後の再発防止と説明責任に効いてくる論点ね。覚えておいて。',
                  expression: 'serious',
                },
              ],
            },
        ...
        {
          object_type: 'book',
          position: { landscape: [0.26, 0.4], portrait: [0.6, 0.5] },
          label: '資料棚',
          actions: [
            {
              kind: 'collect',
              ...
              dialogue: [
                {
                  character: '霧島',
                  line: '業界団体の注意喚起だ。取引先を装った請求書メールにマクロ付きファイルを添付し、開封後にC2サーバへ接続させる手口が、直近で全国的に報告されている。今回の型と一致するな。',
                  expression: 'neutral',
                },
              ],
            },
            {
              ...
              dialogue: [
                {
                  character: '橘',
                  line: 'インシデント対応ガイドライン。感染が疑われる端末は、まずネットワークから論理的に隔離し、電源は落とさないこと。揮発性メモリの証拠を失わないためね。',
                  expression: 'neutral',
                },
              ],
            },
        ...
        {
          object_type: 'door',
          position: { landscape: [0.775, 0.55], portrait: [0.78, 0.58] },
          label: 'サーバ室への扉',
    ...
    },
    {
      ...
      hotspots: [
        {
          object_type: 'device',
          position: { landscape: [0.17, 0.45], portrait: [0.08, 0.55] },
          label: 'プロキシサーバ',
          actions: [
            {
              kind: 'collect',
        ...
        {
          object_type: 'device',
          position: { landscape: [0.83, 0.45], portrait: [0.88, 0.55] },
          label: 'メールサーバ',
          actions: [
            {
              kind: 'collect',
              ...
              dialogue: [
                {
                  character: '霧島',
                  line: '問題のメールを確認した。取引先名を騙った件名で、送信元は正規ドメインによく似た別ドメイン。手口は典型的だが、手が込んでいるな。',
                  expression: 'neutral',
                },
              ],
            },
        ...
        {
          object_type: 'person',
          position: { landscape: [0.485, 0.46], portrait: [0.505, 0.555] },
          label: 'サーバ管理者',
          ...
          actions: [
            {
              ...
              dialogue: [
                ...
                {
                  character: '橘',
                  line: 'その判断、結果的に正解ですね。抜かずに待ったから、私たちはまだメモリの証拠を取れる。初動の“ためらい”が保全に効くこともあるのよ。',
                  expression: 'confident',
                },
              ],
            },
            {
              ...
              dialogue: [
                {
                  character: '霧島',
                  line: '回収した添付ファイルをサンドボックスで動かした。マクロが外部URLから追加プログラムを取得し、プロキシログと同じ宛先へビーコンを送っている。この宛先はIoC――侵害の痕跡として、他端末の調査にも使えるぞ。',
                  expression: 'serious',
                },
                {
                  character: '橘',
        ...
        {
          object_type: 'door',
          position: { landscape: [0.645, 0.52], portrait: [0.73, 0.55] },
          label: '執務室への扉',
  ...
  cards: [
    ...
    },
    {
      ...
      source: 'EDR(端末検知・対応)',
      investigation_point_id: 'ip-edr-alert',
      body: '中野のPCで、表計算ソフトのファイルからのマクロ実行に続いて、見慣れないコマンドラインシェルのプロセスが起動した記録をEDRが検知していた。',
      is_dummy: false,
    },
    {
      id: 'card-edr-noise',
    ...
    },
    {
      ...
      source: '社内メールサーバ',
      investigation_point_id: 'ip-mail-log',
      body: '問題のメールは実在する取引先名を騙り、件名は「請求書送付のご連絡」。添付はマクロ付きの表計算ソフトのファイルで、送信元アドレスは正規の取引先ドメインとよく似た別ドメインだった。',
      is_dummy: false,
    },
    {
      id: 'card-mail-noise',
    ...
    },
    {
      ...
      investigation_point_id: 'ip-reference-guideline',
      body: 'マルウェア感染が疑われる端末への初動は、ネットワークからの論理的な隔離(LANケーブル抜線・無線LAN無効化)を優先し、電源は切らないこととされている。電源を落とすと、プロセスや通信先の情報が乗った揮発性メモリの証拠が失われるため。',
      is_dummy: false,
    },
    {
      ...
      source: '情報システム部',
      investigation_point_id: 'ip-witness-itstaff',
      body: '感染が疑われる端末をネットワークから論理的に隔離する(LANケーブル抜線・無線LAN無効化)。電源は落とさず、揮発性メモリとディスクの証拠を保全した後にIoCを抽出し、被害範囲を特定する。あわせて添付ファイルのマクロ自動実行を組織的に無効化し、標的型メールへの注意喚起を周知する。',
      is_dummy: false,
    },
    {
  ...
  resolution: {
    ...
    questions: [
      {
        ...
        choices: [
          ...
          },
          {
            ...
            is_correct: false,
            reply:
              'そのエラーは半年前から続く既知の警告で、時期が合わない。EDRが捉えた不審な流れは、マクロ実行→スクリプト起動から始まっている。侵入口はそこだ。',
          },
        ],
        explanations: [
          {
          ...
          {
            character: '橘',
            line: '時系列で並べて。半年前の警告と今回は別件よ。この整理は、後で「いつ・何が起きたか」を説明する報告の骨子そのものになるわ。曖昧なままだと報告書が書けないの。',
            expression: 'serious',
          },
        ],
        consult_hint:
      ...
      },
      {
        ...
        choices: [
          {
            text: 'ネットワークから論理的に隔離し(LANケーブル抜線・無線LAN無効化)、電源は落とさず揮発性メモリとディスクの証拠を保全する',
            is_correct: true,
            reply:
              'それが正しい初動よ、あなた。IoCを抽出して被害範囲の特定へ進みましょう。この保全が、後の報告と説明責任の裏付けになるわ。',
          },
          {
            text: '感染が疑われる端末の電源を直ちに落とし、被害の拡大を止める',
            is_correct: false,
            reply:
              '電源を切れば、証拠になり得る揮発性メモリの情報が失われるわ。先にネットワークから論理隔離し、メモリ→ディスクの順で保全を。でなければ「何が漏れたか」を説明できず、報告義務を果たせないの。',
          },
        ],
        explanations: [
          {
          ...
          {
            character: '橘',
            line: '証拠保全の原則は「揮発性の高い情報から」。論理隔離→メモリ→ディスクという手順そのものが、後の報告・説明責任の裏付けになるわ。範囲を特定できて初めて、報告要否の判断ができるのよ。',
            expression: 'serious',
          },
        ],
        consult_hint:
    ...
    clear_explanation: [
      ...
      {
        character: '橘',
        line: '経理部長の証言どおり、社内規程の周知不足も一因ね。今回は個人情報の漏えいが確認されたわけではないけれど、取引先の請求データを扱う部署である以上、影響範囲の確認と、個人情報保護法に基づく報告要否の判断を怠らないこと。証拠を保全したからこそ、その判断ができるのよ。',
        expression: 'serious',
      },
      {
        character: '小鳥遊',
        line: 'お疲れ様でした〜、新人さん。紅茶、淹れておきましたよ。……次の現場も、きっと大丈夫。',
        expression: 'smile',
      },
    ],
